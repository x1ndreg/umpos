                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-top">
                            ...
                            <div class="wordset">
                                <ul>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" id="printButton" data-bs-toggle="tooltip" data-bs-placement="top" title="Print">
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                ...
                                                $('#printButton').on('click', function() {
                                                    var printContents = document.getElementById('tablecontents').outerHTML;
                        ...
                        <div class="table-responsive">
                            <table id="tablecontents" class="table datanew">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Date</th>
                                    ...
                                    <?php foreach ($sreport as $report) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteForm<?= $report['repid']; ?>" action="delete_report.php" method="post">
